...
<script charset="utf8" src="../resources/libs/particles/particles.min.js"></script>
<script charset="utf8" src="../resources/libs/bootstrap/js/bootstrap.min.js"></script>
</head>
<body style="background-color: antiquewhite;">
	...
	<nav class="navbar navbar-default" style="background-color: antiquewhite;">
		...
		<div class="container">
			...
			<div class="navbar-header">
				<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#aaaa"
					aria-expanded="false">
					<span style="color: hotpink"><b>展开</b></span>

				</button>
				<img src="../resources/images/indexadv.png" />
			</div>
			<!--这里制作导航首页，论坛等各个按钮-->
			<div class="collapse navbar-collapse" id="aaaa">
				<ul class="nav  navbar-nav">
					...
					<li><a href="#">新闻</a></li>
					<li><a href="#">论坛</a></li>
					<li><a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">全部
				...
				<div class="navbar-form navbar-left visible-lg-block">
					<div class="input-group">
						<input type="text" class="form-control" placeholder="输入关键字"> <span class="input-group-btn">
				...
				<div class="navbar-right navbar-text">
					<a href="#" class="navbar-link">用户登录</a> | <a href="#" class="navbar-link">免费注册</a>
				</div>
	...
	<div class="container">
		...
		<form class="form-horizontal col-md-offset-3 ">
			...
			<div class="form-group text-center">
				<div class="col-md-6">
					<button autocomplete="off" data-loading-text="正在登录..." class="btn btn-danger" type="button" id="cmdLogin">登录</button>
				</div>
			</div>
	...
	<div class="modal" id="aa">
		<div class="col-md-6 col-md-offset-3"
			...
			<p>Overflowing text to show scroll behavior Cras mattis consectetur purus sit amet fermentum. Cras justo odio,
				dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta!</p>
			<p class="text-right">
