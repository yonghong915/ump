...
import com.ump.uias.modules.system.service.impl.DisposableWorkerIdAssigner;

/**
 * https://github.com/baidu/uid-generator/blob/master/README.zh_cn.md 百度id生成器
 * 两种生成器: DefaultUidGenerator、CachedUidGenerator。如对UID生成性能有要求,
 * 请使用CachedUidGenerator 对应Spring配置分别为:
